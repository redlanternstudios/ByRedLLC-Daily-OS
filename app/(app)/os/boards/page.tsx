                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-4 gap-1.5 mt-4">
                    {COLUMN_CONFIG.map(({ key, label, icon: Icon, color }) => (
                      <div key={key} className="rounded-lg bg-zinc-800/60 p-2 text-center">
                        ...
                        <p className="text-[9px] text-zinc-600 leading-tight">{label}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[10px] text-zinc-600">{board.task_count} total tasks</span>
                      <span className="text-[10px] text-zinc-500">{pctDone}% done</span>
                    </div>
